...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> Paharpur Mela </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Shoplist <span class="sr-only"></span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/ss.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">घर बैठे जाने अपने बाजार के हर सस्ती महँगी सामान के बारे में!</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to see....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to see...."> </div>
                            </div>
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Search cheese</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Shoplist</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order cheese</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">The easiest way to your favourite cheese</p>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Shoplist</h3>
                                    <p>We"ve got your covered with menus from over 345 delivery Products online.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your cheese delivered! And enjoy your meal! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best cheese Delivery App</h3>
                                <p>Now you can make cheese happen pretty much wherever you are thanks to the free easy-to-use cheese Delivery &amp; Takeout App.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> पहाड़पुर <br> </a> <br> <span>Order Delivery &amp; Take-Out </span> </div>
                    <div class="col-xs-12 col-sm-2 about color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">We are buying</a> </li>
                            <li><a href="#">We are selling</a> </li>
                        </ul>
                    </div>
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose Shoplist</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Kamalpipra</a> </li>
                            <li><a href="#">Aamwa Gadiyani</a> </li>
                            <li><a href="#">kotawa</a> </li>
                            <li><a href="#">latiya</a> </li>
                            <li><a href="#">GoriTola</a> </li>
                            <li><a href="#">Bartauliya</a> </li>
                            <li><a href="#">Gangapipra</a> </li>
                            <li><a href="#">Sonawal</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Concept design of oline cheese order and deliveye,planned as restaurant directory</p>
                            <h5>Phone: <a href="tel:+080000012222">9525194959</a></h5> </div>
